    ...
    <>
      <form onSubmit={handleSearch} className="w-full max-w-4xl mx-auto p-4 bg-card rounded-lg shadow-md border">
       ...
       <AlertDialog open={isAlertOpen} onOpenChange={setIsAlertOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Search Request Payload</AlertDialogTitle>
            <AlertDialogDescription>
              This is the JSON payload that would be sent to the backend to perform the search.
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <AlertDialogFooter>
            <AlertDialogAction onClick={confirmSearch}>
              Confirm & Continue
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
